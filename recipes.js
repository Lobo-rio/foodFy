module.exports = [
    {
        cardId: '1HDG2',
        cardTitle: 'Triplo bacon burger',
        cardImage: 'assets/burger.png',
        cardAuthor: 'por Jorge Relato',
        ingredients: [
    ...
    {
        cardId: '1HDG3',
        cardTitle: 'Pizza 4 estações',
        cardImage: 'assets/pizza.png',
        cardAuthor: 'por Fabiana Melo',
        ingredients: [
    ...
    {
        cardId: '1HDG3',
        cardTitle: 'Espaguete ao alho',
        cardImage: 'assets/espaguete.png',
        cardAuthor: 'por Jorge Relato',
        ingredients: [
    ...
    {
        cardId: '1HDG4',
        cardTitle: 'Lasanha mac n’ cheese',
        cardImage: 'assets/lasanha.png',
        cardAuthor: 'por Juliano Vieira',
        ingredients: [
    ...
    {
        cardId: '1HDG5',
        cardTitle: 'Docinhos pão-do-céu',
        cardImage: 'assets/doce.png',
        cardAuthor: 'por Ricardo Golvea',
        ingredients: [
            '1 kg de batata - doce',
            '100 g de manteiga',
            '3 ovos',
    ...
    {
        cardId: '1HDG6',
        cardTitle: 'Asinhas de frango ao barbecue',
        cardImage: 'assets/asinhas.png',
        cardAuthor: 'por Vania Steroski',
        ingredients: [
